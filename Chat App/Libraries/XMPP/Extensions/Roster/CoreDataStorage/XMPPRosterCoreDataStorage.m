...
- (NSArray *)usersForJID:(XMPPJID *)jid managedObjectContext:(NSManagedObjectContext *)moc {
    ...
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"streamBareJidStr == %@ AND subscription == 'both'", bareJIDStr];
