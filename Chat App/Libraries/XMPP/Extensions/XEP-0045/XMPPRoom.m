...
- (void)leaveRoom:(XMPPJID *)roomJid
{
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		// <presence type='unavailable' to='darkcave@chat.shakespeare.lit/thirdwitch'/>
        //roomJID = [XMPPJID jidWithString:[roomJid bare]];
		XMPPPresence *presence = [XMPPPresence presence];
        [presence addAttributeWithName:@"from" stringValue:[GETUSERID addHostName]];
		[presence addAttributeWithName:@"to" stringValue:[roomJid full]];
		[presence addAttributeWithName:@"type" stringValue:@"unavailable"];
		NSLog(@"leave room = %@ -> %@", roomJID, presence);
		[xmppStream sendElement:presence];
...
- (void)declineGroupRequest:(XMPPJID *)roomJid invitee:(XMPPJID *)inviteeJId withMessage:(NSString *)declineMessageStr
{
    dispatch_block_t block = ^{ @autoreleasepool {
        ...
        //        <message xmlns="jabber:client" from="vga2@conference.52.65.0.92" to="Xplor@52.65.0.92">
        //            <x xmlns="http://jabber.org/protocol/muc#user">
        //                <invite from="abc@52.65.0.92">
        //                    <reason>Hi from Xplor</reason>
        //                </invite>
        //            </x>
        //            <x xmlns="jabber:x:conference" jid="vga2@conference.52.65.0.92">
        //            </x>
        //        </message>
        
        
        //        <message xmlns="jabber:client" from="bb@conference.52.65.0.92" to="abc@52.65.0.92">
        //            <x xmlns="http://jabber.org/protocol/muc#user">
        //                <decline from="Xplor@52.65.0.92">
        ...
        [decline addAttributeWithName:@"from" stringValue:[[self.xmppStream myJID] full]];
        ...
        NSXMLElement *x2 = [NSXMLElement elementWithName:@"x" xmlns:@"jabber:x:conference"];
        [x2 addAttributeWithName:@"jid" stringValue:[roomJid full]];
        
        XMPPMessage *message = [XMPPMessage message];
        [message addAttributeWithName:@"xmlns" stringValue:@"jabber:client"];
        [message addAttributeWithName:@"from" stringValue:[roomJid full]];
        [message addAttributeWithName:@"to" stringValue:[inviteeJId full]];
        [message addChild:x];
        [message addChild:x2];
