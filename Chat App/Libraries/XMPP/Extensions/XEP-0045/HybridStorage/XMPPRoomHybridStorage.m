...
- (BOOL)existsMessageOutgoing:(XMPPMessage *)message forRoom:(XMPPRoom *)room stream:(XMPPStream *)xmppStream
{
    ...
    NSString *messageJID = [[message toStr] stringByAppendingPathComponent:[streamBareJidStr removeHostName]];
    NSString *messageBody = [[message elementForName:@"body"] stringValue];
    
    NSDate *minLocalTimestamp = [[NSDate date] dateByAddingTimeInterval:-60];
    NSDate *maxLocalTimestamp = [[NSDate date] dateByAddingTimeInterval: 60];
    ...
    //NSLog(@"predicate outgoing = %@", predicate);
...
- (void)handleOutgoingMessage:(XMPPMessage *)message room:(XMPPRoom *)room
{
	...
	[self scheduleBlock:^{
        ...
        if ([self existsMessageOutgoing:message forRoom:room stream:xmppStream])
        {
